...
def get_particle_info(particleName):
    ...
    if particleName == 'Dplus':
        ...
        massSecPeak = ROOT.TDatabasePDG.Instance().GetParticle(413).Mass()
        secPeakLabel = 'D^{*+}'
        ...
        massSecPeak = ROOT.TDatabasePDG.Instance().GetParticle(411).Mass()
        secPeakLabel = 'D^{+}'
        ...
        massSecPeak = ROOT.TDatabasePDG.Instance().GetParticle(4122).Mass()
