...
R2_R3_comp.py
-------------
Script to compare the event-plane resolution between R2 and R3 harmonics
over 0–100% centrality.

Usage:
    python R2_R3_comp.py --input <input_file.root> --output <output_plots_directory>
"""
